...
const NAV: Record<Role, NavConfig[]> = {
  admin: [
    ...
    { href: "/admin/circulars", key: "circulars", icon: Megaphone },
  ...
  teacher: [
    ...
    { href: "/teacher/circulars", key: "circulars", icon: Megaphone },
  ],
  student: [
    ...
    { href: "/student/circulars", key: "circulars", icon: Megaphone },
